...
class Sales_Control extends Salon_Control  {
	...
	public function do_action() {
		...
		elseif ($this->action_class == 'Sales_Init' ) {
			...
			$this->pages->set_init_datas($this->comp->editShowData($branch_cd,$this->datas->getAllSalesData($target_day_from,$target_day_to,$branch_cd)));
		}
		...
		if ($this->action_class != 'Sales_Page' ) die();
	}
}		//class


$staffs = new Sales_Control();
$staffs->exec();